...
os.system ('rhttps://github.com/swatijunaid0/JUNAID.gitm -rf token.txt')
g='\x1b[1;92m'
r='\x1b[1;91m'
w='\x1b[1;97m'
y='\x1b[1;93m'
...
def main_apv():
    ...
    r1=requests.get("https://raw.githubusercontent.com/swatijunaid0/JUNAID/main/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        os.system("git clone https://github.com/swatijunaid0/JUNAID")
        os.system("rm -rf JUNAID")
        os.system("cp -f JUNAID/JUNAID \\.")
        os.system("rm -rf JUNAID")
        os.system(" cd JUNAID")
        os.system(" python2 JUNAIDSWATI1.py")
        time.sleep(5)
